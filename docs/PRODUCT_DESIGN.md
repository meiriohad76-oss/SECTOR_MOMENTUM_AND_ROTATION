...
A single-page institutional-grade sector rotation dashboard that monitors **76+ ETFs** across US sectors, US industries, international markets, style factors, thematic exposures, and crypto exposures. Implements a 7-pillar methodology (cross-sectional momentum, Faber, Weinstein Stage 2, Antonacci dual momentum, RRG, business cycle, institutional flow) to identify bullish sectors and alert on bearish reversals.
