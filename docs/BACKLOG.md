...
**Evidence:** Next handoff browser QA screenshots and similarity report are stored in `docs/browser-qa/next-handoff/latest`; the latest `?presentation=c` run has required text/nonblank passes and similarity around 0.84-0.86.
