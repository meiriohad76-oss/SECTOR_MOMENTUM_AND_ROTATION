...
**Output:** manual summary report and equity chart artifact in `docs/`; dashboard Backtest Lab reads those artifacts when present and renders normalized equity plus drawdown views. Jupyter notebook and full historical methodology report remain follow-up.
