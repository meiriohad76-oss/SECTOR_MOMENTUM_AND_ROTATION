...
**Status:** GitHub Actions workflow, operator guide, local secret-name preflight, and AHADPI5 self-hosted runner path are implemented in `backlog-stepwise-qa`; live workflow validation is in progress.
