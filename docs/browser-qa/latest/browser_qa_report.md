...
Generated: `2026-05-27T03:20:35Z`
...
| `desktop-rrg-spaghetti-drill` | `desktop` | B-111, B-112, B-116 | **PASS** | `docs/browser-qa/latest/desktop-rrg-spaghetti-drill.png` | focused text: US SECTOR RELATIVE STRENGTH visible=true top=429 height=17 scrollTop=6956; nonblank screenshot |
| `desktop-comparison-view` | `desktop` | B-115 | **PASS** | `docs/browser-qa/latest/desktop-comparison-view.png` | focused text: COMPARE TICKERS visible=true top=418 height=22 scrollTop=9574; nonblank screenshot |
| `desktop-transition-pulse` | `desktop` | B-114 | **PASS** | `docs/browser-qa/latest/desktop-transition-pulse.png` | focused text: Recent transitions visible=true top=418 height=22 scrollTop=4281; visible selector: .alert-row.pulse-transition; nonblank screenshot |
...
| `desktop-full-matrix-table` | `desktop` | B-113 | **PASS** | `docs/browser-qa/latest/desktop-full-matrix-table.png` | focused text: FULL 7 visible=true top=418 height=26 scrollTop=13503; hovered first full-table row; visible selector: .full-table tbody tr:first-child .row-preview; nonblank screenshot |
| `tablet-dashboard` | `tablet` | B-110, B-112, B-115 | **PASS** | `docs/browser-qa/latest/tablet-dashboard.png` | focused text: Risk regime visible=true top=418 height=22 scrollTop=2070; nonblank screenshot |
